...
function bicepCurlClick() {
  window.open("exercises/bicep-curl/bicep-curl.html", "_self");
}

function lungesClick() {
  window.open("exercises/lunges/lunges.html", "_self");
}

function deadliftClick() {
  window.open("exercises/deadlift/deadlift.html", "_self");
}
